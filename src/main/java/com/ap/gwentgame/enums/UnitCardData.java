...
public enum UnitCardData {
    ...
    YENNEFER_OF_VENGERBERG("Yennefer of Vengerberg", 7, RANGED_COMBAT, MEDIC, ALL, 1, false),
    ...
    MYSTERIOUS_ELF("Mysterious Elf", 0, CLOSE_COMBAT, SPY, ALL, 1, false),
    COW("Cow", 0, RANGED_COMBAT, TRANSFORMERS, ALL, 1, false),
    EMIEL_REGIS("Emiel Regis", 5, CLOSE_COMBAT, NONE, ALL, 1, false),
    GERALT_OF_RIVIA("Geralt of Rivia", 15, CLOSE_COMBAT, NONE, ALL, 1, false),
    TRISS_MERIGOLD("Triss Merigold", 7, CLOSE_COMBAT, NONE, ALL, 1, false),
    VESEMIR("Vesemir", 6, CLOSE_COMBAT, NONE, ALL, 1, false),
    ZOLTAN_CHIVAY("Zoltan Chivay", 5, CLOSE_COMBAT, NONE, ALL, 1, false),
    KAYRAN("Kayran", 8, AGILE, MORALBOOST, MONSTERS, 1, false),
    ...
    DRAUG("Draug", 10, CLOSE_COMBAT, NONE, MONSTERS, 1, false),
    ...
    IMLERITH("Imlerith", 10, CLOSE_COMBAT, NONE, MONSTERS, 1, false),
    LESHEN("Leshen", 10, CLOSE_COMBAT, NONE, MONSTERS, 1, false),
    ...
    MENNO_COEHOORN("Menno Coehoorn", 10, CLOSE_COMBAT, MEDIC, NILFGAARDIAN_EMPIRE, 1, false),
    ...
    LETHO_OF_GULET("Letho of Gulet", 10, CLOSE_COMBAT, NONE, NILFGAARDIAN_EMPIRE, 1, false),
    MORTEISEN("Morteisen", 3, CLOSE_COMBAT, NONE, NILFGAARDIAN_EMPIRE, 1, false),
    MORVRAN_VOORHIS("Morvran Voorhis", 10, SIEGE, NONE, NILFGAARDIAN_EMPIRE, 1, false),
    ...
    TIBOR_EGGEBRACHT("Tibor Eggebracht", 10, RANGED_COMBAT, NONE, NILFGAARDIAN_EMPIRE, 1, false),
    ...
    ESTERAD_THYSSEN("Esterad Thyssen", 10, CLOSE_COMBAT, NONE, NORTHERN_REALMS, 1, false),
    JOHN_NATALIS("John Natalis", 10, CLOSE_COMBAT, NONE, NORTHERN_REALMS, 1, false),
    KEIRA_METZ("Keira Metz", 5, RANGED_COMBAT, NONE, NORTHERN_REALMS, 1, false),
    PHILIPPA_EILHART("Philippa Eilhart", 10, RANGED_COMBAT, NONE, NORTHERN_REALMS, 1, false),
    ...
    VERNON_ROCHE("Vernon Roche", 10, CLOSE_COMBAT, NONE, NORTHERN_REALMS, 1, false),
    ...
    ISENGRIM_FAOILTIARNA("Isengrim Faoiltiarna", 10, CLOSE_COMBAT, MORALBOOST, SCOIATAEL, 1, false),
    ...
    SEASENTHESSIS("Seasenthessis", 10, RANGED_COMBAT, NONE, SCOIATAEL, 1, false),
    ...
    BERSERKER("Berserker", 4, CLOSE_COMBAT, BERSERKER, SKELLIGE, 1, false),
    YOUNG_BERSERKER("Young Berserker", 2, RANGED_COMBAT, BERSERKER, SKELLIGE, 3, false),
    DRAIG_BON_DHU("Draig Bon-Dhu", 2, SIEGE, NONE, SKELLIGE, 1, false),
    ERMION("Ermion", 8, RANGED_COMBAT, MARDROEME, SKELLIGE, 1, false),
    ...
    CERYS("Cerys", 10, CLOSE_COMBAT, MUSTER, SKELLIGE, 1, false),
    ...
    KAMBI("Kambi", 11, CLOSE_COMBAT, TRANSFORMERS, SKELLIGE, 1, false),
    ...
    HJALMAR("Hjalmar", 10, RANGED_COMBAT, NONE, SKELLIGE, 1, false),
