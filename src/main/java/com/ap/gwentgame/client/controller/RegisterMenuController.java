...
import com.ap.gwentgame.client.enums.ServerCommands;
...
import static com.ap.gwentgame.client.enums.ServerCommands.REGISTRATION_FAILED_USERNAME_TAKEN;
import static com.ap.gwentgame.client.enums.ServerCommands.REGISTRATION_SUCCESSFUL;
...
public class RegisterMenuController {
    ...
    public void signup(MouseEvent mouseEvent) {
        ...
        if (REGISTRATION_FAILED_USERNAME_TAKEN.getMatcher(responseText).matches()){
            ViewUtilities.showErrorAlert("Username already taken", "please");
            return;
        }
